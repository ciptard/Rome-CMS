/**
 * jQuery Cookie extenstion
 * Do whatever you want with this
 * TJ Easmtond <tj.eastmond@gmail.com>
 */
...
(function($) {
	$.fn.cookie = function(name, value, days) {
		...
		/**
		 * Pass in the name of the cookie, the value to set and
		 * how many days it should last. Use a negative number
		 * to unset
		 */
		...
		get = function(cookieName) {
			var i, name, equal, numCookies, cookies = document.cookie.split(";");
